...
namespace DigitalRuby.WeatherMaker
{
    public static class WMS
    {
        ...
        public static readonly int _CloudDirLightLod = Shader.PropertyToID("_CloudDirLightLod");
        ...
        public static readonly int _CloudRaymarchSampleDetailsForDirLight = Shader.PropertyToID("_CloudRaymarchSampleDetailsForDirLight");
        ...
        public static readonly int _DirectionalLightMultiplier = Shader.PropertyToID("_DirectionalLightMultiplier");
        public static readonly int _PointSpotLightMultiplier = Shader.PropertyToID("_PointSpotLightMultiplier");
        ...
        public static readonly int _MainTex5 = Shader.PropertyToID("_MainTex5");
        ...
        public static readonly int _WaterCausticsTintColor = Shader.PropertyToID("_WaterCausticsTintColor");
        public static readonly int _WaterDepthThreshold = Shader.PropertyToID("_WaterDepthThreshold");
        public static readonly int _WaterFoamParam1 = Shader.PropertyToID("_WaterFoamParam1");
        ...
        public static readonly int _WaterRefractionStrength = Shader.PropertyToID("_WaterRefractionStrength");
        ...
        public static readonly int _WeatherMakerCloudShadowDetailTexture = Shader.PropertyToID("_WeatherMakerCloudShadowDetailTexture");
        public static readonly int _WeatherMakerCloudShadowDetailScale = Shader.PropertyToID("_WeatherMakerCloudShadowDetailScale");
        public static readonly int _WeatherMakerCloudShadowDetailIntensity = Shader.PropertyToID("_WeatherMakerCloudShadowDetailIntensity");
        public static readonly int _WeatherMakerCloudShadowDetailFalloff = Shader.PropertyToID("_WeatherMakerCloudShadowDetailFalloff");
        public static readonly int _WeatherMakerCloudShadowDistanceFade = Shader.PropertyToID("_WeatherMakerCloudShadowDistanceFade");
        public static readonly int _WeatherMakerCloudVolumetricShadowSampleCount = Shader.PropertyToID("_WeatherMakerCloudVolumetricShadowSampleCount");
        public static readonly int _WeatherMakerCloudVolumetricShadow = Shader.PropertyToID("_WeatherMakerCloudVolumetricShadow");
        public static readonly int _WeatherMakerCloudVolumetricShadowDither = Shader.PropertyToID("_WeatherMakerCloudVolumetricShadowDither");
        ...
        public static readonly int _WeatherMakerDirLightMultiplier = Shader.PropertyToID("_WeatherMakerDirLightMultiplier");
        ...
        public static readonly int _WeatherMakerDirectionalLightScatterMultiplier = Shader.PropertyToID("_WeatherMakerDirectionalLightScatterMultiplier");
        ...
        public static readonly int _WeatherMakerFogSunShaftsBackgroundIntensity = Shader.PropertyToID("_WeatherMakerFogSunShaftsBackgroundIntensity");
        public static readonly int _WeatherMakerFogSunShaftsBackgroundTintColor = Shader.PropertyToID("_WeatherMakerFogSunShaftsBackgroundTintColor");
        ...
        public static readonly int _WeatherMakerAdjustFullScreenUVStereoDisable = Shader.PropertyToID("_WeatherMakerAdjustFullScreenUVStereoDisable");
        ...
        public static readonly int _WeatherMakerVREnabled = Shader.PropertyToID("_WeatherMakerVREnabled");
        public static readonly int _WeatherMakerWaterDepthMaxUV = Shader.PropertyToID("_WeatherMakerWaterDepthMaxUV");
