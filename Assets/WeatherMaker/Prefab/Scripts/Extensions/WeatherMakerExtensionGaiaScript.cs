...
namespace Gaia.GX.DigitalRuby
{
    ...
    {
        private static WeatherMakerDayNightCycleManagerScript SetLocation(float lat, float lon, bool setDirty = true)
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                WeatherMakerDayNightCycleManagerScript.Instance.Latitude = lat;
                WeatherMakerDayNightCycleManagerScript.Instance.Longitude = lon;
                WeatherMakerDayNightCycleManagerScript.Instance.TimeZoneOffsetSeconds = -1111;
                if (setDirty)
                {
                    SerializationHelper.SetDirty(WeatherMakerDayNightCycleManagerScript.Instance);
                }
                return WeatherMakerDayNightCycleManagerScript.Instance;
            }
            return null;
        }

        private static WeatherMakerDayNightCycleManagerScript SetDateTime(int year, int month, int day, int hour, int min, int sec, bool setDirty = true)
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                WeatherMakerDayNightCycleManagerScript.Instance.Year = year;
                WeatherMakerDayNightCycleManagerScript.Instance.Month = month;
                WeatherMakerDayNightCycleManagerScript.Instance.Day = day;
                WeatherMakerDayNightCycleManagerScript.Instance.TimeOfDay = (float)System.TimeSpan.FromSeconds((3600 * hour) + (60 * min) + sec).TotalSeconds;
                if (setDirty)
                {
                    SerializationHelper.SetDirty(WeatherMakerDayNightCycleManagerScript.Instance);
                }
        ...
        private static void SetTime(System.TimeSpan t)
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                WeatherMakerDayNightCycleManagerScript.Instance.TimeOfDay = (float)t.TotalSeconds;
                SerializationHelper.SetDirty(WeatherMakerDayNightCycleManagerScript.Instance);
            }
        }
...
", "OK");
        ...
        public static void GX_SetTimeOfDay_Dawn()
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                SetTime(WeatherMakerDayNightCycleManagerScript.Instance.SunData.Dawn);
            }
        }
        ...
        public static void GX_SetTimeOfDay_SunRise()
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                SetTime(WeatherMakerDayNightCycleManagerScript.Instance.SunData.SunRise);
            }
        }
        ...
        public static void GX_SetTimeOfDay_Sunset()
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                SetTime(WeatherMakerDayNightCycleManagerScript.Instance.SunData.SunSet);
            }
        }
        ...
        public static void GX_SetTimeOfDay_Dusk()
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                SetTime(WeatherMakerDayNightCycleManagerScript.Instance.SunData.Dusk);
            }
        }
        ...
        public static void GX_SetMoon_Full()
        {
            ...
            WeatherMakerDayNightCycleManagerScript d = SetDateTime(2017, 4, 11, 23, 57, 1, false);
        ...
        {
            SetLocation(40.2338f, -111.6585f, false);
            WeatherMakerDayNightCycleManagerScript d = SetDateTime(2017, 4, 7, 3, 57, 1, false);
            SerializationHelper.SetDirty(d);
        }
        ...
        {
            SetLocation(40.2338f, -111.6585f, false);
            WeatherMakerDayNightCycleManagerScript d = SetDateTime(2017, 4, 4, 23, 57, 1, false);
            SerializationHelper.SetDirty(d);
        }
        ...
        {
            SetLocation(40.2338f, -111.6585f, false);
            WeatherMakerDayNightCycleManagerScript d = SetDateTime(2017, 4, 1, 23, 57, 1, false);
            SerializationHelper.SetDirty(d);
        }
